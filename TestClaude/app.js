document.addEventListener("DOMContentLoaded", () => {
    ...
    const displayLoadout = ({ weapons, specializations, gadgets }) => {
        // Get three unique gadgets for the three slots
        const shuffledGadgets = shuffleArray([...gadgets]);
        const selectedGadgets = shuffledGadgets.slice(0, 3);
    
        // Create arrays for gadget columns, ensuring each selected gadget appears 8 times in its column
        const gadgetsArray1 = Array(8).fill(selectedGadgets[0]);
        const gadgetsArray2 = Array(8).fill(selectedGadgets[1]);
        const gadgetsArray3 = Array(8).fill(selectedGadgets[2]);
        ...
        const loadoutHTML = `
            <div class="items-container">
                ...
                <div class="item-container">
                    <div class="scroll-container">${createItemContainer(gadgetsArray1)}</div>
                </div>
                <div class="item-container">
                    <div class="scroll-container">${createItemContainer(gadgetsArray2)}</div>
                </div>
                <div class="item-container">
                    <div class="scroll-container">${createItemContainer(gadgetsArray3)}</div>
                </div>
            </div>
