...
class RageRouletteAnimationSystem {
  ...
  async animateHandicapSelection() {
    // Select handicap immediately and return after short display
    ...
    // Quick visual display and immediate return
  ...
  `;
    ...
    return new Promise((resolve, reject) => {
      ...
      const animate = () => {
        ...
        try {
          ...
          if (iterationCount % 10 === 0) {
            console.log(`🎰 Handicap animation progress: ${elapsed}ms / ${this.handicapAnimationConfig.totalDuration}ms`);
          }
          ...
          if (elapsed >= this.handicapAnimationConfig.totalDuration) {
            try {
              ...
              console.log('🎲 Handicap selected in roulette:', {
                handicap: this.selectedHandicap,
                description: this.selectedHandicapDesc
              });
      ...
      try {
        ...
        clearTimeout(animationTimeout);
        // Set a default handicap if error occurs
        if (!this.selectedHandicap) {
          this.selectedHandicap = "No Healing";
          this.selectedHandicapDesc = "Cannot use healing items or abilities";
        }
        mainResolve();
      }
    });
