...
// Sound volumes - Ultra quiet mode (max 8% volume)
export const SOUND_VOLUMES = {
  COLUMN_STOP: 0.04, // Column stop sound volume (ultra quiet)
  SPIN_START: 0.06, // Spin start sound volume (ultra quiet)
  SPINNING: 0.02, // Spinning sound volume (ultra quiet)
  TRANSITION: 0.05, // Transition sound between spins (ultra quiet)
  CELEBRATION: 0.08, // Celebration sound at end (ultra quiet)
};

// Maximum volume cap for all sounds
export const MAX_VOLUME_CAP = 0.08;
