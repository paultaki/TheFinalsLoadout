...
class SlotMachine {
  ...
  createSpotlightOverlay() {
    ...
    // Add narrowing effect for final spin
    if (this.isFinalSpin) {
      overlay.classList.add('narrowing');
      // Start with larger spotlight
      overlay.style.setProperty('--spotlight-width', '200%');
      overlay.style.setProperty('--spotlight-height', '80%');
    }
